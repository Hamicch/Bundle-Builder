/**
 * The design's purple satisfaction seal: a scalloped rim, "100%" over the
 * guarantee copy in the center, and "Try worry-free for 30 days" curving
 * along the edge. Built from path geometry as a stand-in for an exported
 * design asset.
 */
...
/** Scalloped-seal outline: alternating outer/inner radius points around the circle. */
