...
/**
 * A single product tile in the builder. Not every card in the design looks
 * the same — badge, color chips, and discount pricing are all optional — so
 * this renders entirely from the product's data rather than special-casing
 * any one item. When the product has variants, the stepper always tracks
