...
/**
 * "Your security system" — the design's live summary of the builder. Items
 * are grouped under the same category subheadings the design shows
 * (Cameras, Sensors, Accessories, Plan), followed by the shipping perk,
 * guarantee seal, financing line, totals, and the save/checkout actions.
 */
export function ReviewPanel() {
  ...
  /**
   * Between md and lg the design (Frame 1736) drops the panel below the
   * builder with line items on the left and the guarantee/returns/checkout
   * summary on the right. Desktop and phone (Frame 1735) stay single-column.
   */
  return (
